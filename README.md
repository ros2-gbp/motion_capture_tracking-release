## motion_capture_tracking (humble) - 1.0.9-1

The packages in the `motion_capture_tracking` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble motion_capture_tracking` on `Mon, 29 Jun 2026 20:38:45 -0000`
...
## motion_capture_tracking (jazzy) - 1.0.9-1

The packages in the `motion_capture_tracking` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy motion_capture_tracking` on `Mon, 29 Jun 2026 20:27:35 -0000`
...
## motion_capture_tracking (lyrical) - 1.0.9-1

The packages in the `motion_capture_tracking` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical motion_capture_tracking` on `Mon, 29 Jun 2026 20:24:37 -0000`
...
## motion_capture_tracking (rolling) - 1.0.9-1

The packages in the `motion_capture_tracking` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling motion_capture_tracking` on `Mon, 29 Jun 2026 20:21:52 -0000`
...
## motion_capture_tracking (lyrical) - 1.0.8-1

The packages in the `motion_capture_tracking` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical motion_capture_tracking` on `Fri, 29 May 2026 20:51:15 -0000`
...
## motion_capture_tracking (rolling) - 1.0.6-1

The packages in the `motion_capture_tracking` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling motion_capture_tracking` on `Sun, 22 Feb 2026 15:23:57 -0000`
...
## motion_capture_tracking (jazzy) - 1.0.6-1

The packages in the `motion_capture_tracking` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy motion_capture_tracking` on `Fri, 13 Jun 2025 08:04:04 -0000`
...
## motion_capture_tracking (humble) - 1.0.6-1

The packages in the `motion_capture_tracking` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble motion_capture_tracking` on `Fri, 13 Jun 2025 08:01:28 -0000`
